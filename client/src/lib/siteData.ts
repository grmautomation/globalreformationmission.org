...
export const videos = [
  { title: 'Global Reformation Mission is live!', age: 'Streamed less than an hour ago', id: '3t_DeQzz5RE' },
  { title: 'La Santification! 2', age: 'Streamed 1 day ago', id: '-pqq8evMEu8' },
  { title: 'L’Eglise(Assemblée)! 21', age: 'Streamed 1 day ago', id: 'sr4WFnsoJ0s' },
  { title: 'Global Reformation Mission is live!', age: 'Streamed 2 days ago', id: 'ccYcdI9vgck' },
];
