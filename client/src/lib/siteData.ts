...
export const videos = [
  { title: 'La Sanctification! 6', age: 'Streamed less than an hour ago', id: 'Ul23iNiEfqM' },
  { title: 'L’Eglise(Assemblée)! 23', age: 'Streamed 1 day ago', id: 'kpG4jjmz5bs' },
  { title: 'La femme selon le cœur de Dieu! 37', age: 'Streamed 2 days ago', id: 'WfkZ1_7h9Fg' },
  { title: '2 Timothée! 5', age: 'Streamed 2 days ago', id: 'MP2E_t3Z5Pc' },
];
