...
export const videos = [
  { title: 'La Sanctification! 9', age: 'Streamed 2 hours ago', id: 'LC_hhp7uGzs' },
  { title: 'Why did Jesus give Simon the name Cephas?', age: 'Streamed 6 hours ago', id: 'PAHlNYwW9Js' },
